  ...
  return (
    ...
    <div className="md:flex mt-16 md:mt-18  md:m-[100px]   items-center ">
        ...
        <div className="md:ml-0 md:mb-56 md:w-[447px] md:h-[168px] w-[300px]  mx-auto">
            <h1 className="scale-y-150 text-30  mt-10 font-700 leading-[30px] md:mb-6 font-bison md:text-[42px]  w-[300px] h-[84px] md:text-start md:font-bold  md:leading-[45px] tracking-tighter text-center text-sblack">BE A PART OF<br/><span className="whitespace-nowrap"> WELLNESS COMMUNITY</span></h1>
