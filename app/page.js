        ...
        <div className="ml-10 mr-10 md:ml-20 md:mr-20 " >
          ...
          <div className="mt-48 flex flex-col  items-center justify-center align-center   md:items-start  ">
              ...
              <p className="bg-custom  text-center text-14 rounded-3xl w-64 p-2 text-white font-jost font-700 leading-20.23 ">START YOUR HEALTHY LIFESTYLE!</p>
               <div className='shadow-custom text-center bg-blue-100 rounded-[40px] p-7 mt-5 w-315 h-416 md:bg-transparent md:text-left md:mt-0 md:p-0 md:rounded-none'>
                  <h1 className="text-30 font-300 leading-42 font-bison text-sblack  h-126  mt-5 flex justify-center items-center align-center md:text-80 md:font-300  md:leading-72">BEGIN YOUR TRANSFORMATION TODAY</h1>
                    ...
                    <div className="flex items-center justify-center align-center mx-auto cursor-pointer rounded-3xl border-2 border-current gap-3  w-175 h-50 mt-5 text-gray md:w-64 "><div className="font-500 text-13.85 leading-16.23  font-roboto ">Show More </div><div><Image src="/triangle.png" width={23.47} height={17.06} /></div></div>
                  </div>
        </div>
      </div>
    </div>
