    ...
    <div>
      ...
      <div className='flex flex-col items-center justify-center w-full lg:mb-[80px]'>
        ...
        <div className='flex flex-col items-center justify-center w-[315px] h-[374px] lg:bg-transparent md:bg-transparent bg-blue-50 rounded-[40px]'>
          <h1 className='hidden  md:text-[35px]  sm:leading-[40px] lg:block md:block lg:text-[40px] text-[30px] text-center lg:w-[718px] md:w-[600px] font-700 leading-[40px] uppercase w-[262px] lg:mt-[-90px] md:mt-[-90px] text-sblack scale-y-150'>Empowering Youth through<br></br>
            Sports Excellence</h1>
          <h1 className='lg  md:text-[35px]  sm:leading-[40px]:hidden md:hidden lg:text-[40px]  text-[25px] text-center lg:w-[718px]  font-700 leading-[30px] uppercase w-[262px] scale-y-150 text-sblack'><span className='whitespace-nowrap '>Empowering Youth</span>
      ...
      <div className='flex lg:flex-row md:flex-row flex-col items-center justify-center lg:mt-[-130px] md:mt-[-70px] mt-7  gap-4 lg:mb-16 md:mb-14'>
        <div className='lg:w-[502px] lg:h-[249px]  relative  w-[315px] h-[264px] border-2 lg:rounded-none rounded-[40px]'>
          ...
          <p className='lg:hidden md:hidden absolute inset-0 bg-blur left-5 top-14 w-[269px] h-[160px] text-white text-center  text-14 lg:text-18'>HISC was established in 2020 with guidance from renowned sports icons like Pullela Gopichand and P. V. Sindhu.
        ...
        <div className='lg:w-[502px] lg:h-[249px] relative w-[316px] h-[265px] border-2 lg:rounded-none rounded-[40px] lg:mt-0 md:mt-0 mt-5'>
          ...
          <p className='lg:hidden md:hidden absolute inset-0 bg-blur left-5 top-14 w-[269px] h-[160px] text-white text-center text-[14px]  lg:text-18'>HISC was established in 2020 with guidance from renowned sports icons like Pullela Gopichand and P. V. Sindhu.
            We have partnered with esteemed organizations including the Ministry of Sports (Government of India),
            Khelo India, FIT India, and the Pullela Gopichand Badminton Academy.</p>
        </div>
      ...
      <div className='w-full lg:h-[488px] lg:mt-[-150px] md:mt-[-140px] mt-[-120px] md:h-[588px]  h-[790px] border-2 flex flex-col items-center justify-center lg:bg-[#0479CE] bg-[#FB491D]'>
        <h1 className='sm:text-[40px]  sm:leading-[40px] text-center leading-[30px] font-bison md:w-full w-[300px] lg:mb-0 md:mt-[100px] mt-[150px] text-[30px] font-700 uppercase text-white scale-y-150  md:text-[35px] lg:text-[47px]'>Inauguration and Location</h1>
        <p className='text-center lg:w-[834px]  w-[315px] md:w-[500px] font-poppins text-[16px]lg:p-0  text-white mt-10 text-14 lg:text-18'>HISC was inaugurated on 26th February 2023 at Kanha Shanti Vanam,
