    ...
    return ( 
        ...
        <>
            ...
            <nav className="flex justify-between ">
                ...
                <div className="text-custom text-[50px] mt-5 md:text-[#0479CE] font-700 md:mt-0 md:text-80 font-poppins   ">HISC </div><div className="hidden lg:block mt-9 text-[#1F1F1F] w-[110px] h-[54px] font-custom font-400 text-[16px] leading-[18px]">Heartfulness International  Sports Center</div> 
                </div>
