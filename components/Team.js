    ...
    <>
      <div className="md:flex mt-10 md:mt-18  md:m-[100px] justify-center items-center ">
        ...
        <div className="md:ml-0 md:mb-56 md:w-[447px] md:h-[168px] w-[300px]  mx-auto">
          ...
          <div className="flex justify-center items-center text-center text-[13.98px] h-50 sm:text-[18px]  md:text-[13.98px]  md:mt-12 mt-6  ml-16 md:ml-0 rounded-3xl p-2 font-jost font-500 leading-20.23  text-white bg-[#0479CE]  w-[175px]">
            SIGN UP NOW
          </div>
        </div>
      </div>
