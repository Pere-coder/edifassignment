  ...
  return (
    ...
    <div className="md:flex mt-16 md:mt-18  md:m-[100px]   items-center ">
        ...
        <div className="md:ml-0 md:mb-56 md:w-[447px] md:h-[168px] w-[300px]  mx-auto">
            ...
            <div className="flex justify-center items-center text-center text-[13.98px] h-[38px] sm:text-[18px] sm:h-[48px] md:text-[13.98px] md:h-[38px] md:mt-12 mt-12  ml-16 md:ml-0 rounded-3xl p-2 font-jost font-500 leading-20.23  text-white bg-custom md:bg-[#0479CE]  w-[175px]">SIGN UP NOW</div>
        </div>
