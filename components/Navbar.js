            ...
            <nav className="flex justify-between ">
                ...
                <div className="text-[#0479CE] text-[50px] mt-5 md:text-[#0479CE] font-700 md:mt-0 md:text-80 font-poppins   ">HISC </div><div className="text-[8px] leading-[10px] mt-10 w-[50px] md:hidden lg:block lg:mt-9 text-[#1F1F1F] lg:w-[110px] lg:h-[54px] font-custom font-400 lg:text-[16px] lg:leading-[18px]">Heartfulness International  Sports Center</div> 
                    ...
                    <ul className="hidden  md:flex gap-10 mt-16  font-roboto font-500 text-[20px]   ">
                        <li className="mt-1 cursor-pointer "><Link href='/'><h1 className="group text-sblack">Home <p className="group-hover:border-b-4 h-1 w-7 border-b-[#0479CE]"></p> </h1></Link></li>
                        <li className="mt-1 cursor-pointer "><Link href='about'><h1 className="group text-sblack">About us <p className="group-hover:border-b-4 h-1 w-7 border-b-[#0479CE]"></p></h1></Link></li>
                        <li className="mt-1 cursor-pointer "><h1 className="group text-sblack">Facility <p className="group-hover:border-b-4 h-1 w-7 border-b-[#0479CE]"></p></h1></li>
