    ...
    <div className="flex flex-col justify-center items-center text-center mt-0 md:mt-20">
        <div className="bg-no-repeat bg-cover bg-center w-[375px] bg-[url('../public/sports.jpg')] h-[470px]  md:h-[530px] md:bg-[url('../public/desktop.jpg')]  md:w-full">
            <div className="w-[375px] h-[470px]   bg-gradient-to-b from-[#000000]  to-transparent  md:w-full  md:bg-gradient-to-b md:from-[#000000] md:t0-transparent">
                <div className='flex  flex-col justify-center  items-center text-center   md:items-end md:mr-[20px]  lg:mr-[180px]'>
                    <div className='w-[316px] h-[180px] md:w-[365px] md:h-[310px] leading-[40px] text-[35px] text-white transform mt-10   md:leading-[50px] md:text-[50px] lg:text-[50px] md:text-[#F1F8FF] md:transform  md:text-start md:mt-[100px]'>
                        <h1 className='font-bison font-500  scale-y-150 md:scale-y-100 '>EXPERIENCE <br/>A   DIFFERENT WAY TO WORK OUT</h1>
