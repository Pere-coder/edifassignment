...
function Template({ select, all_data, boolean }) {
  ...
  return (
    ...
    >
      {/* Up card */}
      <motion.div
        className=" z-10 md:top-[4rem] lg:top-[6rem] xl:top-[2rem] left-1 absolute md:scale-[.70] lg:scale-[.70] opacity-50 blur md:w-[200px] md:h-[290px] lg:w-[250px] lg:h-[300] xl:w-[304px] xl:h-[371.56px] bg-white rounded-[8px] md:mx-8 lg:mx-16 flex flex-col items-center justify-center"
        initial={
      ...
      {/* Down card */}
      <motion.div
        className=" z-10 md:bottom-[4rem] lg:bottom-[6rem] xl:bottom-[2rem] left-1 absolute scale-[.70] opacity-50 blur md:w-[200px] md:h-[290px] lg:w-[250px] lg:h-[300] xl:w-[304px] xl:h-[371.56px] bg-white rounded-[8px] md:mx-8 lg:mx-16 flex flex-col items-center justify-center"
        initial={
