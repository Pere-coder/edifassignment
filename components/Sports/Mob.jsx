...
function Mob({ data, setMobile, mobile }) {
  ...
  return (
    <AnimatePresence>
      <div className={" w-full relative "} style={{ display: mobile ? "" : "none" }}>
        <motion.div
        ...
        <div className=" w-full absolute min-h-screen top-0 bg-gradient-to-b from-white via-transparent to-transparent  md:bg-gradient-to-r md:from-white md:to-transparent md:via-[#E6F2F4]"></div>
        <motion.div
